...
namespace H3MP
{
    internal class H3MP_ClientSend
    {
        ...
        {
            using (H3MP_Packet packet = new H3MP_Packet((int)ClientPackets.integratedFirearmFire))
            {
                packet.Write(trackedID);
                packet.Write((short)roundType);
                packet.Write((short)roundClass);
        ...
        public static void SosigSetCurrentOrder(H3MP_TrackedSosigData trackedSosig, Sosig.SosigOrder currentOrder)
        {
        ...
        {
            using (H3MP_Packet packet = new H3MP_Packet((int)ClientPackets.revolverCylinderLoad))
            {
                packet.Write(trackedID);
        ...
        {
            using (H3MP_Packet packet = new H3MP_Packet((int)ClientPackets.grappleGunLoad))
            {
                packet.Write(trackedID);
                packet.Write((byte)speedLoader.Chambers.Count);
                for (int i = 0; i < speedLoader.Chambers.Count; ++i)
